...
tournois = {
	...
	10: [Masters1000("BNP Paribas Open", "Indian Wells", 96, "Hard", num_rounds=7),
	...
	12: [Masters1000("Miami Open", "Miami", 96, "Hard", num_rounds=7),
	...
	14: [ATP250("Millennium Estoril Open", "Estoril", 28, "Clay", num_rounds=5),
		 ATP250("Grand Prix Hassan II", "Marrakech", 28, "Clay", num_rounds=5),
		 ATP250("Fayez Sarofim Clay Court Championships", "Houston", 28, "Clay", num_rounds=5),
	...
	15: [Masters1000("Rolex Monte Carlo Masters", "Monte-Carlo", 56, "Clay", num_rounds=6),
	...
	16: [ATP500("Barcelona Open Banc Sabadell", "Barcelona", 48, "Clay", num_rounds=6),
		 ATP250("BMW Open", "Munich", 28, "Clay", num_rounds=5),
		 ATP250("Tiriac Open", "Bucharest", 28, "Clay", num_rounds=5),
	...
	17: [Masters1000("Mutua Madrid Open", "Madrid", 96, "Clay", num_rounds=7),
	...
	19: [Masters1000("Internazionali BNL d'Italia", "Rome", 96, "Clay", num_rounds=7),
	...
	21: [ATP250("Gonet Geneva Open", "Geneva", 28, "Clay", num_rounds=5),
		 ATP250("Open Parc", "Lyon", 28, "Clay", num_rounds=5),
	...
	24: [ATP250("Libema Open", "'s-Hertogenbosch", 28, "Grass", num_rounds=5),
		 ATP250("Boss Open", "Stuttgart", 28, "Grass", num_rounds=5),
	...
	25: [ATP500("Terra Wortmann Open", "Halle", 32, "Grass", num_rounds=5),
		 ATP500("Cinch Championships", "London", 32, "Grass", num_rounds=5),
	...
	26: [ATP250("Mallorca Championships", "Mallorca", 28, "Grass", num_rounds=5),
		 ATP250("Rothesay International", "Eastbourne", 28, "Grass", num_rounds=5),
	...
	29: [ATP500("Hamburg Open", "Hamburg", 32, "Clay", num_rounds=5),
		 ATP250("Nordea Open", "Bastad", 28, "Clay", num_rounds=5),
		 ATP250("EFG Swiss Open Gstaad", "Gstaad", 28, "Clay", num_rounds=5),
		 ATP250("Infosys Hall Of Fame Open", "Newport", 28, "Grass", num_rounds=5),
	...
	30: [ATP250("Plava Laguna Croatia Open Umag", "Umag", 28, "Clay", num_rounds=5),
		 ATP250("Generali Open", "Kitzbuhel", 28, "Clay", num_rounds=5),
		 ATP250("Atlanta Open", "Atlanta", 28, "Hard", num_rounds=5),
	...
	31: [ATP500("Mubadala Citi DC Open", "Washington DC", 48, "Hard", num_rounds=6),
	...
	32: [Masters1000("National Bank Open", "Montreal", 56, "Hard", num_rounds=6),
	...
	33: [Masters1000("Cincinnati Open", "Cincinnati", 56, "Hard", num_rounds=6),
	...
	34: [ATP250("Winston Salem Open", "Winston Salem", 48, "Hard", num_rounds=6),
	...
	38: [ATP250("Chengdu Open", "Chengdu", 28, "Hard", num_rounds=5),
		 ATP250("Hangzhou Open", "Hangzhou", 28, "Hard", num_rounds=5),
	...
	39: [ATP500("Kinoshita Group Japan Open", "Tokyo", 32, "Hard", num_rounds=5),
		 ATP500("China Open", "Beijing", 32, "Hard", num_rounds=5),
	...
	40: [Masters1000("Rolex Shanghai Masters", "Shanghai", 96, "Hard", num_rounds=7),
	...
	42: [ATP250("European Open", "Antwerp", 28, "Indoor Hard", num_rounds=5),
		 ATP250("Almaty Open", "Almaty", 28, "Indoor Hard", num_rounds=5),
		 ATP250("BNP Paribas Nordic Open", "Stockholm", 28, "Indoor Hard", num_rounds=5),
	...
	43: [ATP500("Swiss Indoors Basel", "Basel", 32, "Indoor Hard", num_rounds=5),
		 ATP500("Erste Bank Open", "Vienna", 32, "Indoor Hard", num_rounds=5),
	...
	44: [Masters1000("Rolex Paris Masters", "Paris", 56, "Indoor Hard", num_rounds=6),
	...
	45: [ATP250("Moselle Open", "Metz", 28, "Indoor Hard", num_rounds=5),
		 ATP250("Watergen Gijon Open", "Gijon", 28, "Indoor Hard", num_rounds=5),
